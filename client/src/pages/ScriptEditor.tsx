...
// } from "@shared/schema"; // ProductCategory removed as not directly used
...
//     useEffect(() => {
//         console.log(
//             "[ScriptEditor] Script context changed. Current script ID:",
//             script?.id,
//         );
...
//         // Added !script to ensure it only shows if script is truly not loaded
//         return (
...
//     if (!script) {
//         // If no script is loaded (e.g., first visit or after an error/clear)
//         return (
