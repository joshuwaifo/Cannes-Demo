...
//   Product as DbProduct,
//   ProductCategory as DbProductCategoryEnumMap,
//   Script as DbScriptType,
//   Scene as DbScene,
//   SceneVariation as DbSceneVariation,
//   Actor as DbActor,
//   Location as DbLocation,
//   FilmRatingEnum,
//   // FilmRatingType, // Not directly used here, but fine to keep
//   DemographicGenderEnum,
//   // DemographicGenderType, // Not directly used here
//   DemographicAgeEnum,
//   // DemographicAgeType, // Not directly used here
//   GenreEnum,
//   // GenreType, // Not directly used here
// } from "@shared/schema";
// import { ControversyLevel as ServerControversyLevel } from "../../../server/services/ai-suggestion-service"; // Import from server types
...
//   estimatedAgeRange?: string;
//   // --- NEW FIELDS ---
//   roleType?: "Lead" | "Supporting" | "Cameo" | "Unknown"; // AI-derived role type
//   recommendedBudgetTier?: "Low" | "Medium" | "High" | "Any"; // AI-derived budget tier for this role
//   description?: string; // A concise AI-generated description of the character
//   gender?: "Male" | "Female" | "Non-Binary" | "Unknown"; // AI-derived gender
//   // --- END NEW FIELDS ---
// }

// export type ControversyLevel = ServerControversyLevel;
...
//   allScriptCharacters: ScriptCharacter[]; // This now contains richer character objects
//   isLoadingAllScriptCharacters: boolean;
//   // filmGenre and projectBudgetTier from UI can still be passed as user overrides/preferences
//   filmGenre?: string; 
//   projectBudgetTier?: "low" | "medium" | "high" | "any"; 
// }

// // --- END MODIFIED CharacterCastingProps ---
...
export type ScriptGenerationFormData = z.infer<typeof dbScriptGenerationFormSchema>;