...
export async function registerRoutes(app: Express): Promise<Server> {
    ...
    // Character extraction now handled by the modular AI agent system in character-casting-routes.ts
    // app.get(`${apiPrefix}/scripts/:scriptId/characters`, async (req, res, next) => { ... });

        // Import needs to be at the top of file

    // Actor suggestions now handled by the modular AI agent system in character-casting-routes.ts
    // app.get(`${apiPrefix}/characters/:characterName/suggest-actors`, async (req, res, next) => { ... });
    
    // Batch character suggestions now handled by the modular AI agent system in character-casting-routes.ts
    // app.post(`${apiPrefix}/characters/batch-suggest-actors`, async (req, res, next) => { ... });
    
    // Prefetch character suggestions now handled by the modular AI agent system in character-casting-routes.ts
    // app.post(`${apiPrefix}/scripts/:scriptId/prefetch-character-suggestions`, async (req, res, next) => { ... });
